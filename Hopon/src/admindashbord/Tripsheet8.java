...
public class Tripsheet8 {
		    ...
		    srchemp.sendKeys("pre");
		    Thread.sleep(3000);
		    driver.findElement(By.xpath("//ul[@class='ui-autocomplete-items ui-autocomplete-list ui-widget-content ui-widget ui-corner-all ui-helper-reset']")).click();
		    Thread.sleep(3000);
