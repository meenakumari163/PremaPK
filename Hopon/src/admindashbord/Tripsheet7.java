...
public class Tripsheet7 {
    ...
    System.setProperty("webdriver.chrome.driver","./driver/chromedriver.exe");
	    ...
	    srchemp.sendKeys("Rasmi");
	    Thread.sleep(3000);
        driver.findElement(By.xpath("//ul[@class='ui-autocomplete-items ui-autocomplete-list ui-widget-content ui-widget ui-corner-all ui-helper-reset']//li[@class='ui-autocomplete-item ui-autocomplete-list-item ui-corner-all ui-state-highlight']")).click();
